    ...
    <div id="hintdiv">
        ...
        <table class="hint-table">
            <tr>
                ...
                <td><span class="ru-teng">ч</span> <span class="ru">ч</span> <input type="checkbox"></td>
                <td><span class="ru-teng">к</span> <span class="ru">к</span> <input type="checkbox"></td>
            </tr>
            <tr>
                <td><span class="ru-teng">д</span> <span class="ru">д</span> <input type="checkbox" checked="checked"></td>
                <td><span class="ru-teng">б</span> <span class="ru">б</span> <input type="checkbox" checked="checked"></td>
